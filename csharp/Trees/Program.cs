...
namespace Trees
{
	class Program
	{
		static void Main(string[] args)
		{
			...
			var dataBlocks = new[] { "A", "B", "C", "D", "E" };
			MerkleTree tree = new(dataBlocks);

			Console.WriteLine("Merkle Root: " + tree.Root.Hash);
			Console.WriteLine("Verify 'A': " + tree.VerifyData("A"));
			Console.WriteLine("Verify 'E': " + tree.VerifyData("E"));
